    ...
    <section class="content">
			...
			<div class="container-fluid" data-aos="zoom-out" data-aos-delay="100">
				...
				<div class="list-group-item">
					...
					<?php 
						if(isset($_GET['KEYWORDS']) || $_GET['TRACK'] || ($_GET['PUB_YEAR_FROM']) || ($_GET['PUB_YEAR_TO'])){
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `tbl_storage` WHERE IS_ACTIVE='1' AND PUBLISHED_YEAR BETWEEN '".$_GET['PUB_YEAR_FROM']."' AND '".$_GET['PUB_YEAR_TO']."' OR TRACK LIKE'%".$_GET['TRACK']."%'");
