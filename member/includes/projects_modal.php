    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="projects_add.php" enctype="multipart/form-data">
          		  <div class="row">
                    <div class="col-sm-12">
            	...
            	<form class="form-horizontal" method="POST" action="projects_edit.php" id="form-edit-news" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                       <div class="form-group">
                             ...
                             <textarea rows="8" class="form-control summernote" name="details" value="" placeholder="DETAILS" required></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
                       <div class="form-group">
...
<div class="modal fade" id="myModalDelete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="projects_delete.php" method="POST" id="form-delete-news">
