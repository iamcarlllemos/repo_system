              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-nowrap">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM tbl_repository tr INNER JOIN tbl_member tm ON tr.STUDENT_NO=tm.STUDENT_NO WHERE tr.FILESTATUS='1' AND tm.ID !='".$user['ID']."' ORDER BY DATETIME DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                        <tr>
                          <td><?=$cnt; ?></td>
                          <td><a href="member_info.php?search=<?=intval($row['ID']);?>" class="text-primary"><?=htmlentities($row['LASTNAME'].', '.$row['FIRSTNAME'].' '.$row['MI']); ?></a></td>
                          ...
                          <td>
                            ...
                            <td align="right">
                            <a href="repository_download.php?FILEID=<?=intval($row['FILEID']);?>" class="btn bg-gradient-teal btn-sm"><i class="fa fa-solid fa-download"></i> </a>  
                          </td>
                        </tr>
                      <?php
					        $cnt++;
