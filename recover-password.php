		...
		<div class="col-md-8 mt-3">
		  <div class="card card-outline card-teals offset-md-5" style="color:#000">
			...
			<div class="card-body">
			  ...
			  <p class="login-box-msg">WELCOME  <b><?=$userss['LASTNAME'].', '.$userss['MI'].' '.$userss['FIRSTNAME'];?></b></p>
			  <form action="recover_pass_submit.php" method="post" autocomplete="off">
				<div class="input-group mb-3">
				<input type="hidden" name="id" class="form-control" value="<?=$userss['ID'];?>">
				...
				<div class="row">
				  <div class="col-6">
					<button type="submit" name="btnrecover" class="btn bg-maroon btn-block">SUBMIT</button>
				  </div>
				  <div class="col-6">
