				...
				<div class="list-group-item">
					<div class="row">
						<div class="col px-12">
							...
							<a  href="projects.php" class="float-right nav-links btn btn-primary btn-sm">
					...
					<?php 
						if(isset($_GET['KEYWORDS']) || ($_GET['PUB_YEAR_FROM']) || ($_GET['PUB_YEAR_TO'])){
							echo '<div class="alert alert-primary"><i>Search results '.$_GET['KEYWORDS'].' '.$_GET['PUB_YEAR_FROM'].' '.$_GET['PUB_YEAR_TO'].'</i></div>';
						}else{
