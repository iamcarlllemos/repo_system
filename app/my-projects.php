            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped text-nowrapS">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT *,tn.ID as newsID FROM tbl_storage tn LEFT JOIN tbl_admin tm ON tn.POST_BY_ID=tm.ID WHERE tm.ID ='".$user['ID']."' ORDER BY tn.POSTING_DATE ASC";
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="right">
                            ...
                            <a href="my-projects_update.php?search=<?=$row['newsID'];?>" class="btn bg-teal btn-sm edit"><i class="fa-solid fa fa-edit"></i> </a>
                            <button data-id="<?=$row['newsID'];?>" onclick="confirmFullyDelete(this);" data-title="<?=htmlentities($row['POST_TITLE']); ?>" class="btn bg-maroon btn-sm delete"><i class="fa-solid fa fa-trash"></i> </button>
                            </div>
                          </td>
                        </tr>
                      <?php
