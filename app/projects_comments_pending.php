        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <h3 class="card-title"> 
              <!-- <a href="#add" data-toggle="modal" class="btn bg-olive btn-sm"><i class="fa fa-plus"></i> POST PROJECT</a> -->
              <i class="fa fa-list"></i> PROJECTS TITLE
            </h3>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT *,tn.ID as newsID, tc.ID as commID FROM tbl_storage tn INNER JOIN tbl_comments tc ON tn.ID=tc.NEWS_ID WHERE STATUS=0 ORDER BY tn.POSTING_DATE ASC";
