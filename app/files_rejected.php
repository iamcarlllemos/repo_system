        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title"> 
              <i class="fa fa-solid fa-list"></i> FILE LISTS
              </h3>
              ...
              <table id="example1" class="table table-bordered table-striped text-nowrap">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM tbl_repository tr INNER JOIN tbl_member tm ON tr.STUDENT_NO=tm.STUDENT_NO WHERE tr.FILESTATUS='2' ORDER BY DATETIME DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                        <tr>
                          <td><?=$cnt; ?></td>
                          <td data-mytooltip="tooltip" data-placement="top" title="<?=$row['REMARKS']?>">
                          <?php 
