        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><i class="ionicons ion-android-call"></i> Contact</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td align="right">
                          <div class="btn-group">
                            <button data-id="<?=$row['CID'];?>"  class="btn bg-gradient-teal btn-sm edit"><i class="fa-solid fa fa-edit"></i> </button>
                            <button data-id="<?=$row['CID'];?>"  class="btn bg-gradient-maroon btn-sm delete"><i class="fa fa-solid fa-trash-can-xmark"></i> </button>
                           </div>
                          </td>
                        </tr>
                      <?php
