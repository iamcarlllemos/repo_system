	...
	if(isset($_POST['submit'])){			
		...
		if(!empty($_FILES["PDF_FILE"]["name"])) { 
				...
				if(move_uploaded_file($FILE_TEMP, $LOCATION)){
					$insert = $conn->query("INSERT INTO tbl_storage(POST_BY_ID,POST_TITLE,POST_TITLE_SLUG,POST_DETAILS,POSTED_BY,PDF_FILE,STUDENT_NO,FILE_SIZE,PUBLISHED_YEAR,COURSE)
					VALUES('$POST_BY_ID','$POST_TITLE','$POST_TITLE_SLUG','$POST_DETAILS','$POSTED_BY','$RENAME_FILE','$STUDENT_NO','$FILE_SIZE','$PUBLISHED_YEAR','$COURSE')");
					if($insert){ 
