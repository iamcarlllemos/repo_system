            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT *,tn.ID as newsID, tc.ID as commID FROM tbl_storage tn LEFT JOIN tbl_comments tc ON tn.ID=tc.NEWS_ID WHERE STATUS=1 ORDER BY tn.POSTING_DATE ASC";
