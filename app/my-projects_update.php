        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title"> 
              <a href="my-projects.php" class="btn bg-maroon btn-sm"><i class="fa fa-sharp fa-solid fa-arrow-left"></i> BACK</a>
              </h3>
              ...
              <!-- /.card-header -->
              <form class="form-horizontal" method="POST" action="my-projects_update_save.php" enctype="multipart/form-data">
              <div class="card-body">
          		  <div class="row">
