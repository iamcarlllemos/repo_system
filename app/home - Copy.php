        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-teal">
              <div class="inner">
              <?php
                $sql = "SELECT * FROM tbl_repository WHERE FILESTATUS=0";
                $query = $conn->query($sql);
                echo "<h3>".$query->num_rows."</h3>";
              ?>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-maroon">
              <div class="inner">
              <?php
               $sql = "SELECT * FROM tbl_repository WHERE FILESTATUS=1";
                $query = $conn->query($sql);
                echo "<h3>".$query->num_rows."</h3>";
              ?>
              ...
              <a href="my-project.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
              <?php
                $sql = "SELECT * FROM tbl_repository WHERE FILESTATUS=2";
                $query = $conn->query($sql);
                echo "<h3>".$query->num_rows."</h3>";
              ?>
