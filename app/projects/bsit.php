    ...
    <body class="hold-transition sidebar-mini">
	  ...
	  <section class="text-center text-white" style="background:rgba(190, 46, 221,0.40)">
        ...
        <div class="card" style="box-shadow:none;background:rgba(190, 46, 221,0.40)">
		  <h1 class="jumbotron-heading">PROJECTS TITLE</h1>
			...
			<div class="container-fluid" data-aos="zoom-out" data-aos-delay="100">
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `tbl_storage` WHERE IS_ACTIVE='1' AND COURSE='BSIT'");
					$total_records = mysqli_fetch_array($result_count);
					$total_records = $total_records['total_records'];
					$total_no_of_pages = ceil($total_records / $total_records_per_page);
					$second_last = $total_no_of_pages - 1; // total page minus 1
		
					$news = "SELECT * FROM tbl_storage WHERE IS_ACTIVE='1' AND COURSE='BSIT' ORDER BY POSTING_DATE DESC LIMIT $offset, $total_records_per_page"; 
