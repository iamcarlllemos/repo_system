		 ...
		 <section class="content">
			...
			<div class="container-fluid" data-aos="zoom-out" data-aos-delay="100">
				...
				<div class="list-group-item">
					<div class="row">
						<div class="col px-12">
						<h3 class="text-uppercase"><span class="fa fa-solid fa-folder-open text-warning"></span> List of Projects Title
							<a class="float-right nav-links btn bg-gradient-warning text-white" data-widget="navbar-searchs" href="#search_title" role="button" data-toggle="modal">
                                ...
                                <div class="col px-4">
                                    <div>
                                        <div class="float-rightS">
										 <h3><a style="color:#34495e;" href="<?='projects/projects-details.php?news='.urlencode(base64_encode($value['ID']));?>"><?=$value['POST_TITLE'];?></a></h3>
										...
										<a class="read_more" href="<?='projects/projects-details.php?news='.urlencode(base64_encode($value['ID']));?>"> Read More</a>
										</p>
				...
				<?php include "projects_recent.php";?>
