            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT * FROM tbl_event ORDER BY start_datetime DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td align="right">
                            <div class="btn-group">
                            <button data-id="<?php echo $row['id'];?>"  class="btn bg-gradient-teal btn-sm edit"><i class="fa-solid fa fa-edit"></i> </button>
                            <button data-id="<?php echo $row['id'];?>"  class="btn bg-gradient-maroon btn-sm delete"><i class="fa-solid fa fa-trash"></i> </button>
                            </div>
                          </td>
                        </tr>
                      <?php
