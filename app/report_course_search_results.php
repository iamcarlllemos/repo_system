...
<?php
	...
	if($_GET['IS_ACTIVE']==0){ 
		...
		$echo ='APPROVED';
	}elseif($_GET['IS_ACTIVE']==2){
		$echo ='REJECTED';
	}
function generateRow($conn){
	$contents = '';
	$sql = "SELECT * FROM tbl_storage WHERE COURSE ='".$_GET['COURSE']."' AND IS_ACTIVE ='".$_GET['IS_ACTIVE']."' ORDER BY VIEW_COUNTER DESC";
...
class MYPDF extends TCPDF {
  ...
  public function Footer() {
    ...
    <table cellpadding="2" width="100%" border="1" style="border-collapse: collapse">
			<tr>	
				<th width="100%" colspan="6">COURSE: '.$_GET['COURSE'].' ['.$echo.']</th>
			</tr>
			<tr>
