...
<div class="modal fade" id="profile">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="btn-group">
            	<button type="button" class="btn bg-gradient-warning btn-sm" data-dismiss="modal"><i class="fa fa-close"></i> CLOSE</button>
            	<button type="submit" class="btn bg-gradient-maroon btn-sm" name="upload"><i class="fa fa-solid fa-floppy-disk-circle-arrow-right"></i> SUBMIT</button>
</div>	
            </form>
          	</div>
        </div>
...
<div class="modal fade" id="logout">
  <div class="modal-dialog">
    ...
    <div class="modal-footer">
    <div class="btn-group">
      <button type="button" class="btn bg-warning btn-sm" data-dismiss="modal"><i class="fas fa-close"></i> CLOSE</button>
      <a href="logout.php" class="btn bg-maroon btn-sm"><i class="fa fa-sharp fa-solid fa-right-from-bracket"></i> LOGOUT</a>
</div>
    </div>
...
<div class="modal fade" id="editProfile">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
            <div class="btn-group">
              <button type="button" class="btn bg-warning btn-sm" data-dismiss="modal"><i class="fa fa-close"></i> CLOSE</button>
              <button type="submit" class="btn bg-maroon btn-sm" name="save"><i class="fa fa-solid fa-trash-can-xmark"></i> SUBMIT</button>
</div>
            </div>
			  </form>
          </div>
