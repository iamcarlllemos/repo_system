    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
              ...
              <div class="btn-group">
            	...
            	<button type="submit" class="btn bg-maroon btn-sm" name="submit"><i class="fas fa-sharp fa-solid fa-floppy-disk-circle-arrow-right"></i> SUBMIT</button>
</div>	
            </form>
          	</div>
        </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            <div class="btn-group">
                <button type="button" class="btn bg-warning btn-sm" data-dismiss="modal"><i class="fa fa-times"></i> NO</button>
                <button type="submit" name="submit" class="btn bg-maroon btn-sm"><i class="fas fa-sharp fa-solid fa-floppy-disk-circle-arrow-right"></i>  YES</button>
</div>
            </div>
            </form>
        </div>
