              ...
              <form class="form-horizontal" method="POST" action="setting_edit.php?return=<?=basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" id="form-system-update">
                    ...
                    <div class="col-sm-6">
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?=$SYS_EMAIL;?>" name="SYS_EMAIL" placeholder ="EMAIL ADDRESS" required>
                        </div>
                    </div>
                    <div class="col-sm-12">
                       <div class="form-group">
                    ...
                    <div class="col-sm-12">
                       <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="SYS_ABOUT" placeholder ="ABOUT US" required><?=$SYS_ABOUT;?></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
