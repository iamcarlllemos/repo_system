		 ...
		 <section class="content">
			...
			<div class="container-fluid container" data-aos="zoom-out" data-aos-delay="100">
				...
				<div class="list-group-item">
					<div class="row">
						<div class="col px-12">
							<h5 class="text-uppercase"><span class="fa fa-solid fa-folder-open text-primary"></span> All LISTS OF BSIT/BSIS PROJECTS
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$news = "SELECT * FROM tbl_storage WHERE IS_ACTIVE='1' AND IS_ARCHIVED = 0 ORDER BY POSTING_DATE DESC LIMIT $offset, $total_records_per_page"; 
