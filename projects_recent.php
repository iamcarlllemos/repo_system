	<div class="col-md-4 mt-3">
		<div class="card card-default">
		  ...
		  <div class="card-body">
			...
			<div class="list-group">
			  <a href="<?='projects-details.php?news='.urlencode(base64_encode($recent['ID']));?>" class="list-group-item list-group-item-action" aria-current="true">
		...
		<div class="card card-default">
		  ...
		  <div class="card-body">
			...
			<div class="list-group">
			  <a href="<?='projects-details.php?news='.urlencode(base64_encode($most_views['ID']));?>" class="list-group-item list-group-item-action" aria-current="true">
				<div class="d-flex w-100 justify-content-between">
